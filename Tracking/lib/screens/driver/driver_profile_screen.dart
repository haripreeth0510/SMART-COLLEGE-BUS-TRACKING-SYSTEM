...
class _DriverProfileScreenState extends State<DriverProfileScreen> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildProfileDetailRow(
                          'License Number:',
                          _formatLicenseNumber(driverData['licenseNumber']),
                        ),
                      ],
                    ),
                  ),
  ...
  String? _formatLicenseNumber(dynamic licenseNumber) {
    if (licenseNumber is! String) return null;
    return licenseNumber.replaceFirst(RegExp(r'^KA(?=\d)'), 'TN');
  }
