...
class _StudentRoutesScreenState extends State<StudentRoutesScreen> {
  ...
  List<LatLng> parseCoordinates(String coordinates) {
    ...
    // Remove degree symbols, spaces, and directional letters (e.g., °N, °E)
    String cleanCoordinates = coordinates.replaceAll(RegExp(r'[^\d.,-]'), '');
    List<String> coords = cleanCoordinates.split(',');
