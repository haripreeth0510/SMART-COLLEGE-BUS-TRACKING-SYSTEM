...
class _AdminRegisterDriverScreenState
  ...
  String? _validateEmail(String? value) {
    ...
    final emailRegex = RegExp(r'^[\w-\.]+@(gmail\.com|srec\.ac\.in)$');
    if (!emailRegex.hasMatch(value)) {
      return 'Email must end with @gmail.com or @srec.ac.in';
    }
    return null;
  }
  ...
  String? _validateLicense(String? value) {
    ...
    if (!licenseRegex.hasMatch(value)) {
      return 'License number must be in format TN23 20220004001';
    }
    return null;
  }
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Email',
                    helperText: 'Must end with @gmail.com or @srec.ac.in',
                  ),
